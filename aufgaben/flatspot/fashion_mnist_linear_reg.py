...
train_torch(model, train_loader, valid_loader, epochs=50, lr=0.001, title="FashionMNIST_Linear_Regulated_50",
            warmup_steps=1000, weight_decay=0.01, early_stopping_patience=5)